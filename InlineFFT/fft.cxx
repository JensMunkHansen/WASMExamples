...
public:
  static inline float sin()
  {
    ...
    return (I * 2 * M_PI / N) *
      (1 -
        (I * 2 * M_PI / N) * (I * 2 * M_PI / N) / 2 / 3 *
          (1 -
            (I * 2 * M_PI / N) * (I * 2 * M_PI / N) / 4 / 5 *
              (1 -
                (I * 2 * M_PI / N) * (I * 2 * M_PI / N) / 6 / 7 *
                  (1 -
                    (I * 2 * M_PI / N) * (I * 2 * M_PI / N) / 8 / 9 *
                      (1 -
                        (I * 2 * M_PI / N) * (I * 2 * M_PI / N) / 10 / 11 *
                          (1 -
                            (I * 2 * M_PI / N) * (I * 2 * M_PI / N) / 12 / 13 *
                              (1 -
                                (I * 2 * M_PI / N) * (I * 2 * M_PI / N) / 14 / 15 *
                                  (1 -
                                    (I * 2 * M_PI / N) * (I * 2 * M_PI / N) / 16 / 17 *
                                      (1 -
                                        (I * 2 * M_PI / N) * (I * 2 * M_PI / N) / 18 / 19 *
                                          (1 -
                                            (I * 2 * M_PI / N) * (I * 2 * M_PI / N) / 20 /
                                              21))))))))));
  }
};
...
public:
  static inline float cos()
  {
    ...
    return 1 -
      (I * 2 * M_PI / N) * (I * 2 * M_PI / N) / 2 *
      (1 -
        (I * 2 * M_PI / N) * (I * 2 * M_PI / N) / 3 / 4 *
          (1 -
            (I * 2 * M_PI / N) * (I * 2 * M_PI / N) / 5 / 6 *
              (1 -
                (I * 2 * M_PI / N) * (I * 2 * M_PI / N) / 7 / 8 *
                  (1 -
                    (I * 2 * M_PI / N) * (I * 2 * M_PI / N) / 9 / 10 *
                      (1 -
                        (I * 2 * M_PI / N) * (I * 2 * M_PI / N) / 11 / 12 *
                          (1 -
                            (I * 2 * M_PI / N) * (I * 2 * M_PI / N) / 13 / 14 *
                              (1 -
                                (I * 2 * M_PI / N) * (I * 2 * M_PI / N) / 15 / 16 *
                                  (1 -
                                    (I * 2 * M_PI / N) * (I * 2 * M_PI / N) / 17 / 18 *
                                      (1 -
                                        (I * 2 * M_PI / N) * (I * 2 * M_PI / N) / 19 / 20 *
                                          (1 -
                                            (I * 2 * M_PI / N) * (I * 2 * M_PI / N) / 21 / 22 *
                                              (1 -
                                                (I * 2 * M_PI / N) * (I * 2 * M_PI / N) / 23 /
                                                  24)))))))))));
  }
};
...
public:
  enum _r4
  {
    I4 = (((unsigned)I & 0xaaaa) >> 1) | (((unsigned)I & 0x5555) << 1)
  };
  enum _r3
  {
    I3 = (((unsigned)I4 & 0xcccc) >> 2) | (((unsigned)I4 & 0x3333) << 2)
  };
  enum _r2
  {
    I2 = (((unsigned)I3 & 0xf0f0) >> 4) | (((unsigned)I3 & 0x0f0f) << 4)
  };
  enum _r1
  {
    I1 = (((unsigned)I2 & 0xff00) >> 8) | (((unsigned)I2 & 0x00ff) << 8)
  };
  enum _r
  {
    reverse = ((unsigned)I1 >> bitNum<N>::nbits)
  };
};
...
{
public:
  static inline float tempr(const float& wr, const float& wi, float* array, const int j)
  {
...
{
public:
  static inline float tempi(const float& wr, const float& wi, float* array, const int j)
  {
...
public:
  ...
  static inline void loop(const float& wr, const float& wi, float* array)
  {
    ...
    // Loop
    FFTInnerLoop<go * N, go * MMAX, go * M, go*(unsigned)(I + 2 * MMAX)>::loop(wr, wi, array);
  }
};
...
public:
  ...
  static inline void loop(float* array)
  {
    ...
    // Loop
    FFTMLoop<go * N, go * MMAX, go*(unsigned)(M + 2)>::loop(array);
  }
};
...
public:
  ...
  static inline void loop(float* array)
  {
    ...
    // Loop
    FFTOuterLoop<go * N, go*(unsigned)(MMAX << 1)>::loop(array);
  }
};
